...
//         if (newStock < 0) {
//             showToast(`⚠️ Not enough stock for ${item.name}.`);
//             return;
//         }
...
//     let remainingCredits = userData.credits - (useCreditsCheckbox.checked ? userData.credits : 0) + earnedCredits;
...
//         totalAmount,
//         finalAmount,
//         creditsUsed: useCreditsCheckbox.checked ? userData.credits : 0,
...
// ------------------------------------------
// Contact: support@snackstore.com
// Website: www.snackstore.com
// Thank you for shopping with Snack IT!
// ------------------------------------------
// `;
...
function generateInvoice(orderData) {
    ...
    Contact: support@snackstore.com
    Website: www.snackstore.com
    Thank you for shopping with Snack Store!
    ------------------------------------------
    `;
